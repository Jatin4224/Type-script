...
const names = Array.of("jai", "jatin");
...
const numberToStrings = numbers.map((curValue) => curValue.toString());
//Filter
// 1) filtering even numbers
const evenNumbers = numbers.filter((curELM) => curELM % 2 === 0);
console.log(evenNumbers);
//2)filtering number > 3
const numberGreaterThenThree = numbers.filter((currElm) => currElm > 3);
